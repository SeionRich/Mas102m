...
author: "Seion Richardson | sar21@hi.is"
date: "`r Sys.Date()`"
...
![(#fig:fig02) Data collection sampling protocol used to collect the data for this project](C:\Users\UNUFTP\Documents\MyGit\Mas102m\SamplingProtocol2.png){width=75%}
...
library(tidyverse) #[1]. Summarize data 
library(kableExtra) #[2]. Also creates tables 
library(bookdown) #[3]. Build this html book
```

**The sources for the packages used in this project are as follows:**\n

[@R-bookdown]; [@R-base]; [@R-bookdown]; [@R-dplyr]; [@R-forcats]; [@R-ggplot2]; [@R-kableExtra]; [@R-knitr]; [@R-purrr]; [@R-readr]; [@R-rmarkdown]
[@R-stringr]; [@R-tibble]; [@R-tidyr]; [@R-tidyverse]
[@bookdown2016]; [@ggplot22016]; [@knitr2015]; [@knitr2014]; [@rmarkdown2018]; [@rmarkdown2020]; [@tidyverse2019].
