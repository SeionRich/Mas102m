...
All together 3,477 individual fish were measured belonging to 13 species. Of this amount *Stellifer rastrifer* (989), *Stellifer microps* (718), *Macrodon ancylodon* (480), *Nebris microps* (262), *Bagre bagre* (239) and *Cynoscion virescens* (215) were the six most common species measured (Table 4.1). These species collectively accounted for 2903 (83.5%) of the total discarded fish species measured. On the other hand, *Trichiurus lepturus* (30), *Anchoa spinifer* (30) and *Larimus breviceps* (62) were the least abundant. Fish species lengths ranged from a minimum of 2 cm (*Stellifer rastrifer* and *Stellifer microps*) to 70 cm (*Trichiurus lepturus*). The median lengths for all species except *Trichiurus lepturus* (60 cm) and *Paralonchurus elegans* (23 cm) were below 20 cm.  

### Subsetting the top 6 most common fish species measured 

After seeing the length distribution for the fish species measured (Table 4.1) we will now zoom in on the 6 most commonly measured. Before any analysis it is important to inspect the data visually. 
...
```{r, fig.width = 8, fig.height = 5.5, fig.align = "center", fig.cap = "Scatter plot of discarded fish species lengths across bottom trawl fishing tows. A total of 48 bottom trawl fishing tows were made. Most of the length observations are below 40 cm. Trichiurus lepturus was removed."}
...
From the scatter plot (Figure 4.4), we see that for the 48 bottom trawl fishing tows conducted, the lengths ranged  between 2 cm to 70 cm. Despite this range most of the points were below 40 cm. The exceptional points are from a single fish species (*Trichiurus lepturus*) which generally grows large. This species was removed (Figure 4.5) so that we can better see the distribution. The data points (lengths) for each species seems tightly distributed, which is a good sign. With this confirmation, we can now go ahead with the data analysis. 
...
```{r, fig.align = "center", fig.cap = "Histogram of discarded fish species length-distribution by time of day. Colours used to represent the different time of day. To better see the distribution *Trichiurus lepturus* was removed"}
...
For more details; including answers to these questions, please click on links to your left to access the respective Chapters. 
