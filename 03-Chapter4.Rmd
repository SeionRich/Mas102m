...
Chapter 4 was focused on a **Length Analysis** of the discarded fish species caught offshore Guyana. To achieve this a separate dataset (*LengthImport*) containing length measurements was **Joined** to the original data (*ObserverData*) used in Chapter 3 which contained the weight measurements for the **Weight Analysis**. This brings me to end of this project where the following research questions were answered:
